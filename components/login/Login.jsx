...
const remember = useRef();
  ...
  return (
    <div className=" w-screen h-screen flex flex-col items-center justify-center bg-background z-20 overflow-hidden blurcontainer px-4 ">

      <div className="w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 mb-6 card bg-white z-10 rounded-md shadow-md flex flex-col">
      <h1 className="text-2xl font-bold mb-5 text-primary">Login</h1>
        ...
        <div className="flex w-full items-center ">
          ...
          onClick={HandleEmailSignIn}
            className="ml-auto w-1/2 bg-primary text-white p-2 rounded font-semibold hover:bg-gray-900"
            type="submit"
          >
            Log In
          </button>
...
<div onClick={handleGoogle} className="google-login flex gap-3 form-input items-center justify-center mb-10 bg-white shadow-md rounded-md px-5 py-2 ">
...
<p className=" w-full  text-center text-slate-200 text-sm flex gap-2 justify-center ">Dont have an account?   <Link href="/signup" className="text-primary">SignUp</Link></p>
