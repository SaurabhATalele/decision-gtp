...
const remember = useRef("");
  ...
  return (
    <div className="relative w-screen h-screen flex flex-col items-center justify-center bg-background z-20 overflow-hidden blurcontainer px-4 ">

      <div className="w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 mb-6 card bg-white z-10 rounded-md flex flex-col">
