  ...
  return (
    <div className=" relative w-screen h-screen flex flex-col items-center justify-center bg-background z-20 overflow-hidden blurcontainer px-4 blurcontainer">
      <div className="w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 mb-6 card bg-white rounded-md flex flex-col items-center">
        ...
        <h1 className="text-2xl font-bold mb-5 text-primary">SignUp</h1>
        ...
        <div className="w-full flex items-center justify-center">
          ...
          onClick={HandleEmailSignUp}
            className=" w-1/2 bg-primary text-white p-2 rounded font-semibold hover:bg-gray-900 "
            type="submit"
          >
            Sign Up
          </button>
      ...
      <div className="text-right w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 mb-6 "> */}
        ...
        <div
        onClick={handleClick}
        className="w-full sm:w-3/4 shadow-md google-login flex gap-3 form-input items-center justify-center mb-10 bg-white rounded-md px-5 py-2 ">
          <Image
            loader={loader}
            src={"image.png"}
            width={20}
