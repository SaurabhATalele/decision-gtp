...
const Submit = (props: Props) => {
  ...
  return (
    <motion.button
        ...
        className={`h-16 w-16 sm:mb-12 mt-3 sm:mt-0  self-center bg-primary text-white  transition-all ease-in-out duration-100 uppercase tracking-[4px] z-20 flex justify-center items-center rounded-full ${
